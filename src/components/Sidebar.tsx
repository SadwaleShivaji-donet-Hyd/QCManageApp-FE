        ...
        <div style={{
          ...
          {!collapsed && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, overflow: 'hidden' }}>
              <img
                src={logo}
                alt="QuantumCyte"
                style={{ height: 28, width: 'auto', maxWidth: 140, objectFit: 'contain', flexShrink: 0 }}
                onError={e => {
                  const el = e.target as HTMLImageElement;
                  el.style.display = 'none';
                  const span = document.createElement('span');
                  span.textContent = 'QuantumCyte';
                  span.style.cssText = 'color:#fff;font-weight:700;font-size:15px;white-space:nowrap;';
          ...
          <button
            ...
            style={{
              ...
              color: 'rgba(255,255,255,0.75)', padding: 6, borderRadius: 7,
            ...
            <div style={{
              ...
              <input
                ...
                style={{
                  ...
                  color: '#fff', fontSize: 13, width: '100%', fontFamily: 'inherit',
                }}
              />
              <ScanIcon />
            </div>
        ...
        <div style={{ padding: collapsed ? '0 10px 16px' : '0 12px 16px' }}>
          <button
            ...
            style={{
              ...
              gap: 8, transition: 'background 0.15s', fontFamily: 'inherit',
            }}
          >
            <PlusIcon />
            {!collapsed && 'New'}
          ...
          {!collapsed ? (
            <>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                ...
                <div style={{ minWidth: 0 }}>
                  ...
                  <div style={{ color: 'rgba(255,255,255,0.55)', fontSize: 11, textTransform: 'capitalize' }}>
              ...
              <button
                ...
                style={{
                  ...
                  padding: '5px 2px', borderRadius: 6, fontFamily: 'inherit',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
              ...
              <button className="sb-logout" onClick={handleLogout} title="Log out"
                style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.6)', display: 'flex', transition: 'color 0.15s' }}>
                <LogoutIcon />
              </button>
            </div>
          )}
